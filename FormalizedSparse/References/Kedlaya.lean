...
open LaurentSeries in
/-- **Kedlaya (2017), Theorem 11.11 = Kedlaya (2001a), Theorem 15.**

A series `x = ∑ᵢ xᵢ tⁱ ∈ 𝔽̄_p((t^ℚ))` is integral over `𝔽̄_p((t))` if and only if both:
...
arises from an `𝔽ᵃ_[p]⸨X⸩`-algebraic element of `𝔽̄_p((t^ℚ))`. -/
